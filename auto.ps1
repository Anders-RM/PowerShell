...
winget install --id=Mozilla.Firefox.ESR  -e -h --accept-package-agreements --accept-package-agreements
winget install --id=Microsoft.VisualStudioCode  -e -h --accept-package-agreements --accept-package-agreements
winget install --id=Git.Git  -e -h --accept-package-agreements --accept-package-agreements
winget install --id=7zip.7zip  -e -h --accept-package-agreements --accept-package-agreements
